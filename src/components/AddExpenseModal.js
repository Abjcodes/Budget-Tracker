...
//defaultBudgetId is for setting uncategorized as default
    ...
    <Modal show = {show} onHide = {handleClose}>
        <Form onSubmit={handleSubmit}>
            ...
            <Modal.Body>
                ...
                <Form.Group className = "mb-3" controlId="budegtId">
                    <Form.Label>
                        Budget
                    </Form.Label>
                    <Form.Select defaultValue = {defaultBudgetId} ref = {budgetIdRef}>
                        <option id = {UNCATERGOARIZED_BUDGET_ID}>Uncategorized</option>
                        {budgets.map(budget => (
